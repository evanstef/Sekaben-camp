        ...
        <Slider {...settings}>
            ...
            <div ref={satu} className='grid md:grid-cols-2 lg:grid-cols-3 gap-20'>
                {product.map((item, index) => (
                  <motion.div key={index} initial={index % 2 === 0 ? {opacity: 0, x: 150} : {opacity: 0, x: -150}} animate={viewOne ? {opacity: 1, x: 0, transition : {duration : 0.7, delay : 0.3 * index}} : {}} className="mx-auto lg:w-[400px] bg-base-100 shadow-xl rounded-xl duration-300 ease-in-out">
