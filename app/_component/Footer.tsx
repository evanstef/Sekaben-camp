            ...
            <div className='container mx-auto px-7 md:px-0'>
                <div className='flex flex-col items-center md:items-start md:flex-row md:justify-between border-b-2 border-white pb-4'>
                    ...
                    <div className='space-y-3 w-full md:w-1/2 mb-5 md:mb-0'>
                        ...
                        <h1 className='font-bold text-xl'>Sekaben Camp</h1>

                        <div className='text-lg'>
                            <h1>Jl Belakang Metro,Rejosari, Pangkal Balam</h1>
                            <h1>Pangkal Pinang City, Bangka Belitung Islands 33172, Indonesia</h1>
                        </div>
                    </div>

                    <div className='space-y-4 flex flex-col w-full lg:flex-row lg:justify-between md:w-1/2'>
                        <div className='flex flex-col items-center'>
                            <h1 className='font-bold lg:text-xl'>Company</h1>
                            <Link className='hover:text-slate-300 duration-200' href={"/"}>Home</Link>
                            <Link className='hover:text-slate-300 duration-200' href={"/about"}>About</Link>
                        </div>
                        <div className='flex flex-col items-center'>
                            <h1 className='font-bold lg:text-xl'>About Product</h1>
                            <Link className='hover:text-slate-300 duration-200' href={"/product"}>All Produk</Link>
                        </div>
                        <div className='flex flex-col items-center'>
                            <h1 className='font-bold lg:text-xl'>About</h1>
                            <Link className='hover:text-slate-300 duration-200' href={"/about"}>What To Know About Us ?</Link>
                        </div>
                        <div className='flex flex-col items-center'>
                            <h1 className='font-bold lg:text-xl'>Ask Center</h1>
                            <Link className='hover:text-slate-300 duration-200' href={"/contact"}>Contact Us</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className='text-center pt-2'>
                    ...
                    <a href="https://www.instagram.com/sekaben_camp/" target='_blank'>
                        <svg className='cursor-pointer duration-300 ease-in-out hover:fill-lime-500' xmlns="http://www.w3.org/2000/svg" x="0px"     y="0px" width="40" height="40" fill='white' viewBox="0 0 32 32">
                    ...
                    <a href="https://wa.me/6281368757969?text=Halo%20min,%20Saya%20Mau%20Sewa%20Alat%20Camping" target='_blank'>
                        <svg className='cursor-pointer duration-300 ease-in-out hover:fill-lime-500' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" fill="white" viewBox="0 0 32 32">
                    ...
                    <h1>Copyright © 2023 Sekaben Camp Team</h1>
                </div>
            </div>
        </div>
    )
