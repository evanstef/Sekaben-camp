...
const page = () => {
    ...
    const viewTiga : any = useRef()
    const viewEmpat : any = useRef()
    const viewOne = useInView(viewSatu, {margin:"-300px", once:true})
    const viewTwo = useInView(viewDua, {margin:"-300px", once:true})
    const viewThree = useInView(viewTiga, {margin:"-300px", once:true})
    const viewFour = useInView(viewEmpat, {margin:"-300px", once:true})
  ...
  return (
    <>
        ...
        <Wrapper>
          <div ref={viewSatu} className='mb-8 md:my-28 flex flex-col md:flex-row justify-between items-center gap-10'>
           ...
           <div ref={viewTiga} className='flex flex-col md:flex-row items-center justify-between my-28 gap-10'>
