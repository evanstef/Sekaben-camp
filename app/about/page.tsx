...
const page = () => {
    ...
    const view3 : any = useRef()
    const view4 : any = useRef()
    const viewOne = useInView(view1, {margin:"-300px", once:true})
    const viewTwo = useInView(view2, {margin:"-300px", once:true})
    const viewThree = useInView(view3, {margin:"-300px", once:true})
    const viewFour = useInView(view4, {margin:"-300px", once:true})
  ...
  return (
    <>
        ...
        <Wrapper>
          <div ref={view1} className='mb-8 md:my-28 flex flex-col md:flex-row justify-between items-center gap-10'>
           ...
           <div ref={view3} className='flex flex-col md:flex-row items-center justify-between my-28 gap-10'>
