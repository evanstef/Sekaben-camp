...
export default function Home() {
  ...
  const viewOne = useInView(view1, {margin:"-500px", once:true})
  const viewTwo = useInView(view2, {margin:"-600px", once:true})
  ...
  return (
    <>
      ...
      <Wrapper>
        {/* Home Page */}
        <div ref={view1} className="flex flex-col md:flex-row justify-between items-center gap-10 mb-10 md:my-28">
        ...
        <motion.div ref={view2} className="flex flex-col md:flex-row justify-between items-center gap-10 mb-28">
