        ...
        {image.map((image : any, index) => (
          <div key={index}> 
            ...
            <div className="absolute top-0 w-full h-full bg-gradient-to-b from-black/40 via-black/50 to-black">
              ...
              <Link className="bg-green-600 text-[10px] w-[28%] md:w-[35%] lg:w-[16.5%] md:text-xl px-2 flex items-center gap-1 md:gap-3 md:px-5 py-1 rounded-lg lg:text-2xl hover:bg-green-800 duration-300 ease-in-out" href={"https://wa.me/6281212653247?text=Halo%20min,%20Saya%20Mau%20Sewa%20Alat%20Camping"} target="_blank">
                <p>Contact Us</p>
